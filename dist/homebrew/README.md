...
- `release-key-offline` (gating): the formula cannot be published until the
  release tarball is signed by the offline release key and the SHA256 is
  recorded for that signed tarball.
